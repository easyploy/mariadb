...
#mariadb make import source="https://s3.amazonaws.com/easyploy-sample-files/mariadb-import-test/export.zip"
#mariadb make import source="https://s3.amazonaws.com/easyploy-sample-files/mariadb-import-test/export.tar.gz"
#mariadb make mysql-check
